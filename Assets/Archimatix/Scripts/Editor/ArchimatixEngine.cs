	...
	public class ArchimatixEngine  {
		...
		*/
		...
		public static void establishPaths()
		{
			...
			string oldArchimatixAssetPath = Archimatix.ArchimatixAssetPath;
			...
			if (! string.IsNullOrEmpty(oldArchimatixAssetPath) && Archimatix.ArchimatixAssetPath != oldArchimatixAssetPath)
			{
...
//				}
		...
		static void Update () {
			...
			if (library != null &&  ! library.allLibraryThumbnailsLoaded && updateCounter == 499)
			{
...
//				Debug.Log("sceneGUI: " + e.type + " " + e.keyCode);
			...
			if (currentModel != null)
			{
				...
				*/
				...
				float panelWidth 	= Mathf.Min(windowWidth, 450);
